...
var content = $('<div class="timepicker">\
		<div v-show class="title">لطفا انتخاب کنید</div>\
			<div class="chose-all">\
				<div class="handle">\
				...
				<div class="text">\
					<div class="cell-4"><a class="js-hour-show" title="لطفا انتخاب کنید"></a></div>\
					<div class="cell-2">:</div>\
					<div class="cell-4"><a class="js-minute-show" title="نقطه انتخاب" ></a></div>\
				</div>\
				<div class="handle">\
...
timepicker.bindEvent = function () {
	...
	thisTimePicker.hourShow.on('click',function() {
		...
		thisTimePicker.title.text('لطفا یک ساعت را انتخاب کنید');
	});
